...
use AccueilBundle\Entity\Media;
...
class MediaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $media = $em->getRepository('AccueilBundle:Media')->findAll();
    ...
    {
        $medium = new Medium();
        $form = $this->createForm('AccueilBundle\Form\MediaType', $medium);
    ...
    {
        $deleteForm = $this->createDeleteForm($medium);
        $editForm = $this->createForm('AccueilBundle\Form\MediaType', $medium);
