 ...
 */
class Contributeur extends \AccueilBundle\Entity\Contributeur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'id', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'nom', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'prenom', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'email', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'telephone', '' . "\0" . 'AccueilBundle\\Entity\\Contributeur' . "\0" . 'adresse');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Contributeur $proxy) {
