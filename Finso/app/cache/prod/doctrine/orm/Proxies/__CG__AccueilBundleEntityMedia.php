 ...
 */
class Media extends \AccueilBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'projet', '' . "\0" . 'AccueilBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'AccueilBundle\\Entity\\Media' . "\0" . 'nom', '' . "\0" . 'AccueilBundle\\Entity\\Media' . "\0" . 'path', '' . "\0" . 'AccueilBundle\\Entity\\Media' . "\0" . 'type');
        }
