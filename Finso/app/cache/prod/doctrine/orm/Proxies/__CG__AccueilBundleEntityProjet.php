 ...
 */
class Projet extends \AccueilBundle\Entity\Projet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'utilisateur', '' . "\0" . 'AccueilBundle\\Entity\\Projet' . "\0" . 'id', '' . "\0" . 'AccueilBundle\\Entity\\Projet' . "\0" . 'nom', '' . "\0" . 'AccueilBundle\\Entity\\Projet' . "\0" . 'description', '' . "\0" . 'AccueilBundle\\Entity\\Projet' . "\0" . 'montant');
        }
