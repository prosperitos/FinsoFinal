 ...
 */
class Contribution extends \AccueilBundle\Entity\Contribution implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AccueilBundle\\Entity\\Contribution' . "\0" . 'projet', '' . "\0" . 'AccueilBundle\\Entity\\Contribution' . "\0" . 'Contributeur', '' . "\0" . 'AccueilBundle\\Entity\\Contribution' . "\0" . 'montant', '' . "\0" . 'AccueilBundle\\Entity\\Contribution' . "\0" . 'typepayement');
        }
    ...
    public function setTypepayement($typepayement)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTypepayement', array($typepayement));
    ...
    public function getTypepayement()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTypepayement', array());
    ...
    public function setContributeur(\AccueilBundle\Entity\Contributeur $contributeur)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setContributeur', array($contributeur));

        return parent::setContributeur($contributeur);
    }
    ...
    public function getContributeur()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getContributeur', array());

        return parent::getContributeur();
    }
