 ...
 */
class Utilisateur extends \AccueilBundle\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'structure', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'motsdepasse', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'AccueilBundle\\Entity\\Utilisateur' . "\0" . 'telephone');
        }
    ...
    public function setMotsdepasse($motsdepasse)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMotsdepasse', array($motsdepasse));

        return parent::setMotsdepasse($motsdepasse);
    }
    ...
    public function getMotsdepasse()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMotsdepasse', array());

        return parent::getMotsdepasse();
    }
